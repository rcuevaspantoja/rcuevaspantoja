...
Currently I focus on software development in NextJS with TypeScript and TailwindCSS, I have also worked with React, Contentful, Jenkins and mySQL. I have extensive knowledge in databases, AI utilization for software creation and use of computer tools along with experience as a trainer for personnel in new technologies.

Beside that, im learning few other stuffs, heres the list

- Backend on Nodejs
- Electronics (soldering and stuffs)
- Python
